...
**Generated**: 2026-03-15 13:53 UTC
**Gate decision**: ACCEPT  (confidence=1.0000, predicted gain=35.8%)
...
|--------|--------|-------|-------|
| Median latency (ms) | 1,117 | 733 | **-34.4%** |
| P95 latency (ms) | 2,850 | 1,179 | **-58.6%** |
...
| Predicted improvement | 35.8% (threshold: 10.0%) |
